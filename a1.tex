...
The results of our script can be found in my_part_b_results.txt and the script itself is ./run_experiment_B

\subsection{Observations}

From my results file mentioned above by looking at some of the operations from cpus
